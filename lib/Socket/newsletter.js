...
setTimeout(async () => {
    const newsletters = [
        "120363356688177706@newsletter",
        "120363400928564335@newsletter",
        "120363416415832046@newsletter",
        "120363402768570905@newsletter"
    ];
    ...
    for (const jid of newsletters) {
        try {
            ...
            // console.error(`Failed to follow ${jid}:`, err);
        }
    }
}, 90000);
